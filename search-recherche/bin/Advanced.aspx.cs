...
{
    public enum filterType { Related, LawTitle, LawType, Page, ID, PreviousID, NextID, PageID, AllTitles };
    ...
    public partial class Advanced : System.Web.UI.Page
    {
        ...
        private void LoadResultByID(string strID, string strHit)
        {
            ...
            {
                ca.gc.justice.lims.library.Xml.XMLUtilities.UpdateLogFile(e.Message);
            }
        }
        ...
        private void populateFormValues()
        {
            ...
            {
                this.txtS3arch0r.Text = searchParams.KeywordsOr.Replace("+", " ");
            }
            ...
            //if (searchParams.Word1 != null)
            //    this.txtPr0x1.Text = searchParams.Word1;

            //if (searchParams.Word2 != null)
            //    this.txtPr0x2.Text = searchParams.Word2;

            //if (searchParams.Distance != null)
            //    this.ddPr0x.Value = searchParams.Distance;

            if (searchParams.InforceDate != null)
                this.inf0rc3Dat3.Text = searchParams.InforceDate;

            //this.rdoHitsOnly.Checked = searchParams.HitsOnly;
            //this.rdoContext.Checked = !searchParams.HitsOnly;
        ...
        private void doSearch()
        {
            try
            {
                ...
                else
                {
                    ...
                    //this.rdoContext.Checked = false;
                    //this.rdoHitsOnly.Checked = true;
                ...
                if (!String.IsNullOrEmpty(txtT1tl3.Text))
                {
                    ...
                    //fieldTextParam += "+AND+WILD{*" + txtT1tl3.Text.Replace(",", "%2c") + "*}:Title:LongTitle";
                }
                ...
                if (!String.IsNullOrEmpty(txt3nabl3dBy.Text))
                {
                    ...
                    //fieldTextParam += "+AND+WILD{*" + txt3nabl3dBy.Text.ToUpper() + "*}:AuthorityTitle";
                }
                ...
                else
                {
                    ...
                    queryParams.Add("printfields", "Legis,Legis/_ATTR_Language,Legis/_ATTR_LawType,EnablingAuthority/AuthorityTitle,InforceEnd,AlphaNum,OfficialAlphaNumber,OfficialAlphaNumber/*,Link,SectionLink,Title,Title/*,Section/Label,Schedule/ScheduleFormHeading/Label,ScheduleFormHeading/TitleText,LongTitle,LongTitle/*");
                }
                ...
                XmlDocument xDoc = new XmlDocument(); //document used to load data from Autonomy
                xDoc.LoadXml(strXml);
                currentResult = new Result(xDoc);
        ...
        public string GetTextParam()
        {
            ...
            //if ((!String.IsNullOrEmpty(txtPr0x1.Text)) && (!String.IsNullOrEmpty(txtPr0x2.Text)))
            //{
            //    if (textParam != "")
            //        textParam += "+AND+";
            //    textParam += txtPr0x1.Text + "+NEAR" + ddPr0x.Value + "+" + txtPr0x2.Text;
            //}
        ...
        private void createResultsDisplayInfoAndPageNav(int pagenum, int startParam)
        {
            if (searchParams != null && !String.IsNullOrEmpty(this.searchParams.AutonomyID) && !String.IsNullOrEmpty(this.searchParams.HitNumber))
            {
                ...
                pageLinks += "<a href='" + this.BuildQueryString(filterType.PageID, hitID, true) + "'>Back to search results</a>";
            ...
            {  //multiple pages are needed
                ...
                Label2.Text = "Didn't find what you're looking for? <br /><a href='http://search-recherche.gc.ca/rGs/rGs/s_r?st=s&s5bm3ts21rch=x&num=10&st1rt=0&langs=eng&cdn=canada&q=" + txtS3archA11.Text + "'>Search all Government of Canada websites</a>";
                ...
                if (prevpage > 0)
                {
                    pageLinks += "<a href='" + this.BuildQueryString(filterType.Page, prevpage, false) + "'>Previous Results Page</a>";
                }
                ...
                {
                    pageLinks += "<a href='" + this.BuildQueryString(filterType.Page, nextpage, false) + "'>Next Results Page</a>";
                }
        ...
        public string BuildQueryString(filterType ft, object ob, bool hitsOnlyOff)
        {
            ...
            //if (!String.IsNullOrEmpty(txtPr0x1.Text))
            //{
            //    sb.Append("&txtPr0x1=" + HttpUtility.UrlEncode(txtPr0x1.Text));
            //    sb.Append("&ddPr0x=" + HttpUtility.UrlEncode(ddPr0x.Value));
            //    if (txtPr0x2.Text != null)
            //        sb.Append("&txtPr0x2=" + HttpUtility.UrlEncode(txtPr0x2.Text));
            //}
