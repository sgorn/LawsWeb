...
// Created: 8/1/2012 6:41:24 PM

function WebTrends(){
	var that=this;
	// begin: user modifiable
	this.dcsid="dcs7902nd5ihvq0jmbpwr0wnu_8j4x";
	this.domain="j1.justice.gc.ca";
	this.timezone=-5;
	this.enabled=true;
	this.i18n=false;
...
WebTrends.prototype.dcsGetId=function(){
	...
	//AP HACK TO FIX BECAUSE JUSTICE SITE IS NOT HTTPS
	//	document.write("<scr"+"ipt type='text/javascript' src='"+"http"+(window.location.protocol.indexOf('https:')==0?'s':'')+"://"+this.domain+"/"+this.dcsid+"/wtid.js"+"'><\/scr"+"ipt>");
	document.write("<scr"+"ipt type='text/javascript' src='"+"http://"+this.domain+"/"+this.dcsid+"/wtid.js"+"'><\/scr"+"ipt>");
	}
}
